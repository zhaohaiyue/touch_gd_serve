 ...
 * 与客户端交互的基础API
 */
//define(["jcl","base64","mobileExpand","bizMobileExpand"],function(Wade, Base64, mobileExpand, bizMobileExpand) {
import Wade from '../base/jcl';
import Base64 from './base64';
import mobileExpand from './expand-mobile';
import bizMobileExpand from '../../expand/biz-mobile';
